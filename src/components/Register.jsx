...
const Register = () => {
  ...
  const [verificationMessage, setVerificationMessage] = useState(""); // Add this state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setVerificationMessage("Registeration successful! Please, check your email to verify your account.") // Set the message
      ...
      if(error.response && error.response.data.message){
        ...
        setTimeout(()=>{
          navigate("/"); //Redirect after 2 seconds of loading animation
  ...
  return (
    <div className="flex items-center justify-center h-screen ">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-80">
        ...
        <button
          type="submit"
          className={`w-full bg-blue-500 text-black border-2 py-2 rounded hover:bg-blue-600 transition ${
